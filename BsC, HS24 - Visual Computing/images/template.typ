...
#let project(title: "", authors: (), date: none, body) = {
  ...
  align(center, text(size: 11pt)[
    This document is licensed under CC BY-SA 4.0. It may be distributed or modified, as long as the author and the license remain intact. (Inspired by #link("https://github.com/XYQuadrat/eth-cheatsheets/tree/main/viscomp")[jsteinmann's])
  ])
